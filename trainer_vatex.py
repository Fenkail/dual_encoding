...
def parse_args():
    ...
    parser.add_argument('--trainTextCollection', type=str, default='vatex/text_embed_info/train_mean_np', help='train collection')
    parser.add_argument('--valTextCollection', type=str, default='vatex/text_embed_info/val_mean_np', help='validation collection')
    ...
    parser.add_argument('--resume', default='/home/fengkai/model/text_video_model/runs_11_vatex_origin_single/model_best.pth.tar', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
    ...
    parser.add_argument('--postfix', default='runs_10_vatex_origin', help='Path to save the model and Tensorboard log.')
    parser.add_argument('--log_step', default=10, type=int, help='Number of steps to print and record the log.')
    parser.add_argument('--cv_name', default='fengkai_vatex_origin', type=str, help='')
